    ...
    <div className=' px-12 mb-28'>
        ...
        { cartData.items.length > 0 ? <>
            <div className="flex flex-col sm:flex-row items-center justify-between gap-10">
                ...
                <div className="basis-1/4 w-full h-full self-start">
                    <div className=' bg-slate-50 w-[350px] p-8'>
                        ...
                        <div className='flex justify-between items-center mt-8'>
                            ...
                            <p className=" text-slate-800 font-light text-xl tracking-tighter  font-mono">{cartData.totalQuantity} Product</p>
                        </div>
                        <div className='flex justify-between items-center mt-8'>
                            <p className=" text-slate-800 font-light text-xl tracking-tighter font-mono">Sub Total</p>
                            <p className=" text-slate-800 font-light text-xl tracking-tighter font-mono">$ {cartData.totalAmount}</p>
                        </div>
                        <div className=' flex items-center justify-center mt-8'>
                            <Checkout cartProducts={cartData.items}/>
                        </div>
                    </div>
                </div>
            </div>
...
//                         </div>
//                         <div className=' flex items-center justify-center mt-8'>
//                             {/*o <Button className=" bg-black hover:bg-black tracking-tighter justify-center items-center rounded-none w-full flex py-2 text-white font-mono text-lg font-semibold gap-3">
//                                 Process to Checkout
//                             </Button> */}
//                             <Checkout />
//                         </div>
